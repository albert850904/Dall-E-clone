...
const CreatePost = () => {
  ...
  const [generatingImg, setGenergatingImg] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.prompt || !form.photo) {
      alert('please enter a prompt in order to generate image');
      return;
    }
